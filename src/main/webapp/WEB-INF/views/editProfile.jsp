...
<body>
	...
	<div class='container'>
		...
		<form:form class='form-horizontal' role='form' modelAttribute="user"
			action="/bloghub/user/${user.id }/updateProfile" method="post"
			...
			<div class='form-group'>
				<div class='col-md-offset-2 col-md-8'>
					<input class='btn btn-info' type="submit" value="Submit Change" /> <input
						class='btn btn-warning' type="reset" value="Cancel" />
				</div>
			</div>
		</form:form>
	</div>
