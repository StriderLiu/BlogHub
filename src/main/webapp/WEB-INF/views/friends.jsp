	...
	<div class='col-md-7'>
		...
		<table class='table table-hover table-condensed'>
			<tr>
				...
				<td><c:out value="${friends[0].name}"></c:out></td>
			</tr>
			<tr>
				<td><b>Email :</b></td>
				<td><c:out value="${friends[0].email}"></c:out></td>
			</tr>
			<tr>
				<td><b>Phone Number:</b></td>
				<td><c:out value="${friends[0].phoneNumber}"></c:out></td>
			</tr>
			<tr>
				<td><b>Gender :</b></td>
				<td><c:out value="${friends[0].gender}"></c:out></td>
			</tr>
			<tr>
				<td><b>Country :</b></td>
				<td><c:out value="${friends[0].country}"></c:out></td>
			</tr>
			<tr>
				<td><b>City :</b></td>
				<td><c:out value="${friends[0].city}"></c:out></td>
			</tr>
			<tr>
				<td><b>Address :</b></td>
				<td><c:out value="${friends[0].address}"></c:out></td>
			</tr>
		</table>
	</div>
