...
<nav class="navbar navbar-default" role="navigation"
	...
	<div class='container'>
		<c:forEach var="user" items="${users}">
			<div class='row'>
				<div class='col-md-2'>
					<img src="/bloghub/user/${user.id}/photo" height="100"
						width="100" class='img-circle' />
				</div>
				<div class='col-md-2'>
					<a href="/bloghub/manager/${user.id}/view"
						style='font-size: 20px;'><b>${user.name}</b></a>
					<hr>
				</div>
				<div class='col-md-3'>
					<form action="/bloghub/manager/${user.id}/delete" method="post">
						<input type="submit" value="Delete This User" class="btn btn-info">
					</form>
					<hr>
				</div>
			</div>
